...
export default function CashModal({setShowCashModal}) {
        ...
        <View style={styles.container}>
          <View style={[styles.flex, styles.headerView]}>
            <View style={styles.headerTexts}>
              <Text style={styles.title}>Set Up Cash</Text>
              <Text style={styles.subtitle}>
                Please enter your cash API keys. You will find your API keys at
                cash API key dashboard{' '}
              </Text>
            </View>
          ...
          <View style={styles.formView}>
            ...
            <Pressable
              ...
              <Text style={styles.activateText}>
                {isActive ? 'Deactivate Cash' : 'Activate Cash'}
              </Text>
            </Pressable>
