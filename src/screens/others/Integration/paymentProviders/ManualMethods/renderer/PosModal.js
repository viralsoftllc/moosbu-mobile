...
export default function PosModal({setShowPosModal}) {
        ...
        <View style={styles.container}>
          <View style={[styles.flex, styles.headerView]}>
            <View style={styles.headerTexts}>
              <Text style={styles.title}>Set Up Pos</Text>
              <Text style={styles.subtitle}>
                Please enter your pos API keys. You will find your API keys at
                pos API key dashboard{' '}
              </Text>
            </View>
          ...
          <View style={styles.formView}>
            ...
            <Pressable
              ...
              <Text style={styles.activateText}>
                {isActive ? 'Deactivate Pos' : 'Activate Pos'}
              </Text>
            </Pressable>
